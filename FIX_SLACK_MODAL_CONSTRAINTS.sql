-- FIX: Update intake_request constraints to match new Slack modal values
-- Run this SQL in your Supabase SQL Editor to fix the constraint violation error
...
-- Add comments explaining the new category system
...
FROM pg_constraint 
WHERE conrelid = 'intake_request'::regclass 
  AND contype = 'c'
  AND conname LIKE '%intake_request_%_check';
