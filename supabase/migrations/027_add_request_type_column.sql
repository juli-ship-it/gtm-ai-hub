-- Migration: Add request_type column to intake_request table
...
ADD COLUMN request_type text check (request_type in ('real', 'showcase')) default 'real';

-- Add index for better performance
CREATE INDEX idx_intake_request_type ON intake_request(request_type);
