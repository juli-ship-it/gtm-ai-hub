-- Migration: Update intake request permissions for specific user restrictions
-- This migration implements the following rules:
-- 1. Only juliana.reyes@workleap.com can modify intake requests in certain stages
-- 2. Only the requester can edit content fields of their own requests
...
-- Keep existing comment update/delete policies
-- (These are already restrictive - only comment authors can update/delete their own comments)

-- Add a comment explaining the new permission structure
